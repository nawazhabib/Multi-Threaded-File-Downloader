...
public class DownloadTask implements Runnable{
    ...
    public DownloadTask(URL downloadUrl, long startByte, long partSize, String partName, String dowloadDir, CountDownLatch countDownLatch) {
        this.downloadUrl = downloadUrl;
        this.startByte = startByte;
        this.partSize = partSize;
        this.partName = partName;
        this.dowloadDir = dowloadDir;
    ...
    private String getPartFileName () {
        return dowloadDir + File.separator + partName;
    }
